                ...
                <ul>
                    <li>
                        <InputForm.InputFormWrap check={workState}>
                            <input type="text" placeholder="상태" value={workState} onFocus={() => setToastState({ state: true, id: 0 })}
                    ...
                    <li>
                        <InputForm.InputFormWrap check={workState}>
                            <input type="text" placeholder="시간" value={`${timeState.th} : ${timeState.tm == 0 ? '0' + timeState.tm : timeState.tm}`} onFocus={() => setToastState({ state: true, id: 2 })}
