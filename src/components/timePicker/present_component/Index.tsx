...
export default function Index({ timeInfo }: any) {
    ...
    return (
        <UpdateWrap>
            ...
            <InputGroup>
                <ButtonForm.defaultBtn type="radio" id="test11" name="test1" value="출근" onChange={(e: any) => setWorkState(e.target.value)} /><label htmlFor="test11">출근</label>
                <ButtonForm.defaultBtn type="radio" id="test22" name="test1" value="오전 반차" onChange={(e: any) => setWorkState(e.target.value)} /><label htmlFor="test22">반차(오전)</label>
                <ButtonForm.defaultBtn type="radio" id="test33" name="test1" value="오후 반차" onChange={(e: any) => setWorkState(e.target.value)} /><label htmlFor="test33">반차(오후)</label>
                <ButtonForm.defaultBtn type="radio" id="test44" name="test1" value="월차" onChange={(e: any) => setWorkState(e.target.value)} /><label htmlFor="test44">월차</label>
                <ButtonForm.defaultBtn type="radio" id="test55" name="test1" value="외근" onChange={(e: any) => setWorkState(e.target.value)} /><label htmlFor="test55">외근</label>
            </InputGroup>
            < DatePicker
                selected={startDate}
