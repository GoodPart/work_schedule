...
export function insertData(form: any): any {
    return async (dispatch: any, getState: any) => {
        ...
        try {
            const createData = await axios.post("https://myworkday.pe.kr:8888/api/calendar/create", { form }, { withCredentials: true })
...
export function deleteData(_id: any): any {
    return async (dispatch: any, getState: any) => {
        ...
        try {
            ...
            if (getAuthData) {
                const deleteData = await axios.post("https://myworkday.pe.kr:8888/api/calendar/deletebyid", { _id: _id }, { withCredentials: true })
...
export function updateData(form: any): any {
    return async (dispatch: any, getState: any) => {
        ...
        try {
            const updateData = await axios.post("https://myworkday.pe.kr:8888/api/calendar/updatebyid", form, { withCredentials: true });
