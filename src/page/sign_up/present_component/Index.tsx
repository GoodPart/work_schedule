    ...
    return (
        ...
        <div className='layout-wrap'>
            <form action="submit" >
                ...
                <br />
                <InputForm.InputFormWrap check={form.user_id}>
                ...
                <br />
                <InputForm.InputFormWrap check={form.user_pw}>
                ...
                <br />
                <InputForm.InputFormWrap check={form.user_email}>
                ...
                <br />
                <InputForm.InputFormWrap check={form.user_phn}>
                ...
                <br />
                <InputForm.InputFormWrap check={form.office_name}>
                ...
                <br />
                <InputForm.InputFormWrap check={form.team_name}>
                ...
                <br />
                <InputForm.InputFormWrap check={form.rank_title}>
